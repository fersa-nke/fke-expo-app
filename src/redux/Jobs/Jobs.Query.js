    ...
    db.transaction((tx) => {
      tx.executeSql(
        ...
        [
          ...
          jsonObject.SensorDEBatchNumber,
          jsonObject.SensorDEDataMatrix,
          jsonObject.SensorNDEBatchNumber,
    ...
    db.transaction((tx) => {
      tx.executeSql(
        ...
        [
          ...
          updatedData.SensorDEBatchNumber,
  ...
  db.transaction((tx) => {
    tx.executeSql(
      `INSERT OR IGNORE INTO formDataTable (
          ...
          SensorDEBatchNumber, SensorNDEDataMatrix, ShaftPosition, State, WindTurbine) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        data.Comments,
        data.Customer,
        data.CustomerId,
